...
console.log('env-config.js created by Netlify build: API keys configured. Gemini key found: ${!!process.env.APP_GEMINI_API_KEY}, OpenAI key found: ${!!process.env.APP_OPENAI_API_KEY}, BFL.ai key found: ${!!process.env.APP_BFL_API_KEY}');
`;
